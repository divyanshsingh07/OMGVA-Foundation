...
const Satsang = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-saffron/10 relative overflow-x-hidden py-16 md:py-24">
      {/* Mandala background */}
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl md:text-5xl font-serif font-bold text-saffron text-center mb-2">Satsang</h1>
